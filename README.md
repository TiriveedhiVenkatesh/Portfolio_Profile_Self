...
<head>
  ...
  <style>
    ...
    nav ul li {
      margin-left: 24px;
      margin-bottom: 0;                /* Removes bottom margin for true single line */
      white-space: nowrap;
    }
    ...
    /* --- TABLES: Remove white backgrounds --- */
    table {
      width: 100%;
    ...
    th, td {
      ...
      text-align: left;
      vertical-align: top;
      background: transparent !important; /* Transparent background for cells */
    }
    tr:nth-child(even) td {
      background: rgba(21,97,173,0.09);  /* Optional: subtle alternate row highlight */
    }
    tr:hover td {
      background: rgba(21,97,173,0.16);  /* Optional: row hover highlight */
    }
    .achieve-list {
      color: #eee;
      font-size: 1.07em;
